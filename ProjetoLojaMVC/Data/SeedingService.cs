...
using ProjetoLojaMVC.Models.Emuns;

namespace ProjetoLojaMVC.Data
{
    public class SeedingService
    {
        private ProjetoLojaMVCContext _context;

        public SeedingService(ProjetoLojaMVCContext context)//fazendo a inserção de dependencia
        {
            _context = context;
        }

        public void Seed()//esse métodos irá preencher a base de DADOS
        {
            if (_context.Departament.Any() || _context.Seller.Any() || _context.SalesRecord.Any())//se existe algum registro nessas tabelas será interropido
            {
            ...
            //SELLER Vendedor
            Seller s1 = new Seller(1, "Bob Brown", "bob@gmail.com", 1500.00, new DateTime(1998, 4, 21), d1);
            Seller s2 = new Seller(2, "Maria Green", "mariab@gmail.com", 3500.00, new DateTime(1979, 12, 31), d2);
            ...
            Seller s6 = new Seller(6, "Alex Pink", "alex@gmail.com", 3000.00, new DateTime(1997, 4, 3), d2);

            //SELLESRECORD Registro de Venda
            ...
            //MANDAR ADICIONAR OS REGISTRO NO BANCO DE DADOS
